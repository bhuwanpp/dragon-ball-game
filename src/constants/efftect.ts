...
export const friezaBlastSHeight = 135;
export const smallASHeight = 200;
export const finalFSWidth = 504;
export const finalFSHeight = 529;
export const deathBSWidth = 236;
export const deathBSHeight = 231;
// piccolo
export const piccoloBlastSWidth = 159;
export const piccoloBlastSHeight = 135;
export const piccoloAttackSWidth = 256;
export const piccoloAttackSHeight = 64;
